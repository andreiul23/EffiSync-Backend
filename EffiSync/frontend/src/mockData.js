...
export const subscriptionPlans = [
  {
    ...
    price: '€4.99',
    period: '/month',
    subtitle: 'Ad-supported · 1 user',
    features: [
      'AI scans your calendar and slots tasks into your free time automatically.',
      'Dynamic rescheduling — if you miss a task, the AI moves it to the next open window.',
      'Earn performance points for every household activity completed on time.',
      'Monthly stats showing exactly how many hours the app saved you.',
      'Experience supported by relevant household ads to keep the cost low.',
    ],
    featured: false,
  },
  {
    ...
    price: '€7.98 – €39.99',
    period: '/month',
    subtitle: '2 – 10 people · scales with size',
    features: [
      'Sync every member’s calendar to find shared free-time windows.',
      '100% fair delegation — the AI splits chores based on how busy each person is.',
      'Trade system: spend earned points to pass an unwanted task to another member.',
      'Shared history showing clearly who pulled their weight and who slacked off.',
      'Premium experience, 100% ad-free, for fast and clean coordination.',
    ],
    featured: true,
  },
  {
    ...
    price: '€3 – €4',
    period: '/person/month',
    subtitle: '50+ people · billed per seat',
    features: [
      'Premium experience, fully ad-free.',
      'Centralized control panel: monitor task completion rate in real time.',
      'Direct delegation & scheduling — managers can push mandatory tasks or events straight into members’ calendars.',
      'Organization-wide analytics across teams and departments.',
