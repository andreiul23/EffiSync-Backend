...
export const subscriptionPlans = [
  {
    ...
    features: [
      'Smart AI scheduling that fills your free slots automatically',
      'Auto-reschedules anything you miss to the next open window',
      'Earn productivity points for every task completed on time',
      'Monthly report of hours saved and time reclaimed',
      'Light, non-intrusive ads keep the price low',
    ],
    cta: 'Start Solo',
    featured: false,
  },
  {
    ...
    price: '€9.99',
    period: '/month',
    subtitle: 'Up to 6 members · Most popular',
    features: [
      'One synced calendar across the whole household',
      'Fair AI delegation — chores split based on each person’s load',
      'Trade tasks using points you’ve earned',
      'Shared accountability history — see who pulled their weight',
  ...
  },
  {
    ...
    price: '€3',
    period: '/user/month',
    subtitle: '50+ seats · billed annually',
    features: [
      '100% ad-free premium for the whole organization',
      'Live dashboard: completion rates and team workload',
      'Managers can push tasks & events directly into calendars',
      'Org-wide analytics across teams and departments',
