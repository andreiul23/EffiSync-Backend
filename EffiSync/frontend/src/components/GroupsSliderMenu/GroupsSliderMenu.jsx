          ...
          {groups.map(group => (
            <Link to="/groups" key={group.id} className="slider-menu__group" onClick={onClose}>
              ...
              <div className="slider-menu__group-info">
                <span className="slider-menu__group-name">{group.name}</span>
                <span className="slider-menu__group-type">{group.type}</span>
              </div>
              <span className="slider-menu__group-members">{group.members.length} members</span>
            </Link>
          ))}
        </div>
